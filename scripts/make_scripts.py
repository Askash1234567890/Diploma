...
for w in range(1, 6, 2):
    for l in range(1, 6, 2):
        ...
        with open(path_to_load_shape, mode='a', newline='', encoding='utf-8') as file:
            writer = csv.writer(file)
            writer.writerow([ind, w, l])

        with open(path_to_load_scripts + rf'\shape_{ind}.comi', mode='w', encoding='utf-8', newline='') as file:
            # Здесь образец скрипта из файла check.comi
            file.write(f'''
            SKETCH OBJECT=BLOCK +COMPLETE
            PREVIEW OPTION=START REDISPLAY=NO | BLOCK Name='Block' X0=-20 Y0=-10 Z0=10 X1=20 Y1=10 Z1=60
            PREVIEW OPTION=END REDISPLAY=NO |  BLOCK Name='Block' X0=-20 Y0=-10 Z0=10 X1=20 Y1=10 Z1=60
            ...
            PREVIEW OPTION=END REDISPLAY=NO |  BLEND  OPTION=CHAMFER LEFTCHAMFER={w} RIGHTCHAMFER={l}
            ...
            MATERIALS GUIINIT
            MATERIALS PICK 'Pec'
            MATERIALS OPTION=MODIFY MULINEARITY=NONLINEAR MUANISOTROPY=ISOTROPIC BH='Default'
            
            SKETCH OBJECT=CYLINDER +COMPLETE
            PREVIEW OPTION=START REDISPLAY=NO | CYLINDER Name='Cylinder' X0=0 Y0=-20 Z0=0 X1=0 Y1=20 Z1=0 -TUBE SHAPECONTROL=SIMPLE MAJORRADIUS=1 MINORRADIUS=1 TOPRADIUS=1 SIDES=2
            PREVIEW OPTION=END REDISPLAY=NO |  CYLINDER Name='Cylinder' X0=0 Y0=-20 Z0=0 X1=0 Y1=20 Z1=0 -TUBE SHAPECONTROL=SIMPLE MAJORRADIUS=1 MINORRADIUS=1 TOPRADIUS=1 SIDES=2
            
            PICK OPTION=TOGGLE PROPERTY=UniqueName LABEL='Cylinder'
            PREVIEW OPTION=PICK | PICK OPTION=ADD PROPERTY=UniqueName LABEL='Cylinder'
            PREVIEW OPTION=ACCEPT REDISPLAY=NO |  CELLDATA OPTION=MODIFY MATERIALLABEL='Air' POTENTIAL=Default ELEMENTTYPE=Linear LEVEL=10 SIZE=0.2 ELEMSHAPEPREF=NONE
            ...
            PREVIEW OPTION=ACCEPT REDISPLAY=NO |  CELLDATA OPTION=MODIFY MATERIALLABEL='Air' POTENTIAL=Default ELEMENTTYPE=Linear LEVEL=5 SIZE=3 ELEMSHAPEPREF=NONE
            ...
            SELECT OPTION=CURSORHIDE TYPE=COND N=1
            FILTER COMMAND=PICK
            FILTER TYPE=EDGE
            ...
            SKETCH OBJECT=CYLINDER +COMPLETE
            PREVIEW OPTION=END REDISPLAY=NO |  CYLINDER Name='Cylinder-002' X0=0 Y0=-50 Z0=0 X1=0 Y1=50 Z1=0 -TUBE SHAPECONTROL=SIMPLE MAJORRADIUS=90 MINORRADIUS=90 TOPRADIUS=90 SIDES=2
            FILTER COMMAND=CURSORHIDE
            FILTER TYPE=BODY
            ...
            PREVIEW OPTION=ACCEPT REDISPLAY=NO |  CELLDATA OPTION=MODIFY MATERIALLABEL='Air' POTENTIAL=Default ELEMENTTYPE=Linear LEVEL=1 ELEMSHAPEPREF=NONE
            PREVIEW OPTION=PICK | PICK OPTION=ADD PROPERTY=UniqueName LABEL='Cylinder-002'
            ...
            BACKGROUND OPTION=SET SHAPE=REFLECTIONTRIM   XYSYMMETRYPLANE=YES YZSYMMETRYPLANE=YES ROTZNUM=1 ZXSYMMETRYPLANE=NO EMRXY=NORMMAGN EMRYZ=NORMMAGN
            MODEL CREATE
            
            MESH SIZE=10.0 NORMALTOL=30.0 SURFACETOL=0.0 TOLERANCE=1.0E-06 TYPE=PREFERTETRA
